              ...
              {otherArticles.map((art) => (
                ...
                >
                  <div className="space-y-2">
                    ...
                    <h4 className="font-sans text-xs sm:text-sm font-bold text-[#232826] dark:text-[#FAF8F5] group-hover:text-[#1E3D34] dark:group-hover:text-[#74BA9E] line-clamp-2 leading-relaxed">
                      {art.title}
                    </h4>
