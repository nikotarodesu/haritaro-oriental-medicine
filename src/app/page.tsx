      ...
      <section className="relative overflow-hidden washi-pattern border-b border-[#E8E1D1] dark:border-[#22303D] pt-10 sm:pt-16 pb-16 sm:pb-24 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative space-y-10">
          <div className="text-center max-w-3xl mx-auto space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#EBF3EF] dark:bg-[#182823] border border-[#1E3D34]/20 dark:border-[#83BEA8]/30 text-[#1E3D34] dark:text-[#83BEA8] text-xs font-bold tracking-wide">
              <GraduationCap className="w-4 h-4" />
              <span>東洋医学・体系学習 ＆ 臨床推論プラットフォーム</span>
            </div>
            ...
            <p className="text-sm sm:text-base text-[#4A534F] dark:text-[#A8B8C4] leading-relaxed max-w-2xl mx-auto">
              haritaro.jpは、東洋医学を単なる知識の丸暗記ではなく、人体の構造と思考体系として修得するためのWeb学習環境です。
          ...
          <div className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-5 max-w-6xl mx-auto">
            {/* 1. 学ぶ */}
            <Link
              href="/curriculum"
              className="bg-[#FFFFFF]/95 dark:bg-[#17212A]/95 backdrop-blur-sm rounded-2xl border-2 border-[#1E3D34]/20 dark:border-[#2A3B4A] hover:border-[#1E3D34] dark:hover:border-[#74BA9E] p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between group"
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EBF3EF] dark:bg-[#182823] text-[#1E3D34] dark:text-[#83BEA8] text-xs font-bold tracking-wider">
                    <GraduationCap className="w-4 h-4" />
                    <span>体系的に学ぶ</span>
                  </span>
                  <span className="text-xs font-mono font-bold text-[#737C77] dark:text-[#8899A6]">LEARN</span>
                </div>
                <h3 className="font-serif text-xl font-bold text-[#232826] dark:text-[#FAF8F5] mb-2 group-hover:text-[#1E3D34] dark:group-hover:text-[#74BA9E] transition-colors">
                  東洋医学8大体系
                </h3>
                <p className="text-xs text-[#59615D] dark:text-[#A0B0BC] leading-relaxed mb-4">
                  陰陽・五行・気血水・生命機能・病機・診断・治法・実践。暗記を排し、人体の動態システムとして本質から修得。
                </p>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FAF8F5] dark:bg-[#1A2530] text-[#1E3D34] dark:text-[#74BA9E] border border-[#E8E1D1] dark:border-[#263542] text-xs font-bold tracking-wider">
                    <Compass className="w-4 h-4" />
                    <span>根拠を調べる</span>
                  </span>
                  <span className="text-xs font-mono font-bold text-[#737C77] dark:text-[#8899A6]">SEARCH</span>
                </div>
                <h3 className="font-serif text-xl font-bold text-[#232826] dark:text-[#FAF8F5] mb-2 group-hover:text-[#1E3D34] dark:group-hover:text-[#74BA9E] transition-colors">
                  経穴辞典 ＆ 学術リファレンス
                </h3>
            ...
            >
              <div>
                <div className="flex items-center justify-between mb-3">
                  <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#FCF4EB] dark:bg-[#2A2117] text-[#B86924] dark:text-[#E6C387] text-xs font-bold tracking-wider">
                    <Layers className="w-4 h-4" />
                    <span>推論を考える</span>
                  </span>
                  <span className="text-xs font-mono font-bold text-[#B86924] dark:text-[#E6C387]">THINK</span>
                </div>
                <h3 className="font-serif text-xl font-bold text-[#232826] dark:text-[#FAF8F5] mb-2 group-hover:text-[#B86924] dark:group-hover:text-[#E6C387] transition-colors">
                  臨床推論 ＆ 弁証演習
                </h3>
                <p className="text-xs text-[#59615D] dark:text-[#A0B0BC] leading-relaxed mb-4">
